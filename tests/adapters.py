...
from cs336_systems import flash_attention, distributed
...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    return flash_attention.FlashAttention2PyTorch
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    return flash_attention.FlashAttention2Triton
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return distributed.DDPIndividualParameters(module)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return distributed.DDPBucketed(module, bucket_size_mb)
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    return distributed.ShardedOptimizer(params, optimizer_cls, **kwargs)
